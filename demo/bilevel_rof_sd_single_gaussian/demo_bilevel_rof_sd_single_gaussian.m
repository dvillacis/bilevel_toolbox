...
%% Generate parameter evolution animation
create_animation_parameter(info.sol_history,strcat('demo/bilevel_rof_sd_single_gaussian/param_evolution_',datestr(now,'yyyy_mm_dd_HH_MM_SS'),'.gif'));
create_animation_image(info.u_history,strcat('demo/bilevel_rof_sd_single_gaussian/smiley_evolution_',datestr(now,'yyyy_mm_dd_HH_MM_SS'),'.gif'));

%% Save experiment
save(strcat('demo/bilevel_rof_sd_single_gaussian/experiment_',datestr(now,'yyyy_mm_dd_HH_MM_SS')),'info','sol');
