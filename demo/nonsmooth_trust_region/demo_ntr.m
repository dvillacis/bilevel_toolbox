...
lower_level_problem.solve = @(lambda,dataset) solve_ntr_lower_level(lambda,dataset.get_corrupt(6));
...
%% Plotting
imagesc_gray(dataset.get_target(6),1,'Original','131');
imagesc_gray(dataset.get_corrupt(6),1,'Gaussian Noise','132');
